...
minetacut(iConfig.getUntrackedParameter("MinEta", -100.)),
maxetacut(iConfig.getUntrackedParameter("MaxEta", 100.)),
mom_minptcut(iConfig.getUntrackedParameter("MomMinPt", 0.)),
mom_maxptcut(iConfig.getUntrackedParameter("MomMaxPt", 14000.)),
mom_minetacut(iConfig.getUntrackedParameter("MomMinEta", -100.)),
mom_maxetacut(iConfig.getUntrackedParameter("MomMaxEta", 100.))
{
